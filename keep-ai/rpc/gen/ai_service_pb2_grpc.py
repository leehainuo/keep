...
class AIServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.StreamChat = channel.unary_stream(
                '/ai.v1.AIService/StreamChat',
                request_serializer=ai__service__pb2.ChatRequest.SerializeToString,
                response_deserializer=ai__service__pb2.StreamChatResponse.FromString,
                _registered_method=True)
...
def add_AIServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamChat': grpc.unary_stream_rpc_method_handler(
                    servicer.StreamChat,
                    request_deserializer=ai__service__pb2.ChatRequest.FromString,
                    response_serializer=ai__service__pb2.StreamChatResponse.SerializeToString,
            ),
    }
...
class AIService:
    ...
    def StreamChat(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/ai.v1.AIService/StreamChat',
            ai__service__pb2.ChatRequest.SerializeToString,
            ai__service__pb2.StreamChatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
